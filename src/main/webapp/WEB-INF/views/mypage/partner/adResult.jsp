    ...
    <div class="mp-container">
        <div id="mp" class="col-mp">
            ...
            <div class="content-div">
                ...
                <div class="input-div">
                    <p class="result-text">배너 광고 신청이 완료 되었습니다.</p>
                    <p class="result-text">관리자 승인 후 게재됩니다.</p>
                </div>
                <div class="btn-div">
                    <button class="delete-btn" id="ok-btn" onclick="location.href='p-mypage.html'">확인</button>
                </div>
            </div>
        </div>
