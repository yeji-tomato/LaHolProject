...
<body>
    ...
    <div class="mp-container">
        <div id="mp" class="col-mp">
            ...
            <div class="content-div">
                ...
                <div class="input-div">
                    <form>
                        <label for="banner-img">배너 이미지</label>
                        <input type="text" id="banner-name" disabled>
                ...
                <div class="btn-div">
                    ...
                    <button class="delete-btn" id="cancel-btn" onclick="location.href='p-mypage.html'">취소</button>
                </div>
            </div>
        </div>
    ...
    <div id="menuModal2" class="modal3">
        <div class="modal-content3">
            ...
            <button class="select-menuBtn" onclick="location.href='adList.html'">신청내역</button>
        </div>
    </div>
    <script>
