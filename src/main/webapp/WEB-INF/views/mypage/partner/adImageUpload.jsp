    ...
    <div class="mp-container">
        <div id="mp" class="col-mp">
            ...
            <div class="content-div">
                ...
                <div class="input-div">
                    <form action="${ contextPath }/pMypage/adImage" method="POST" id="image_form" enctype="multipart/form-data">
	    ...
	    $(function(){
	        ...
	        function loadImg(element) {
	            if(element.files && element.files[0]) {
	                ...
	                $("#banner-name").val(element.files[0].name);
	                reader.onload = function(e) {
	                    $("#img-preview").attr("src", e.target.result).css({width:"300px", height:"400px", border:"1px solid rgb(255,192,0)"})
	                }
