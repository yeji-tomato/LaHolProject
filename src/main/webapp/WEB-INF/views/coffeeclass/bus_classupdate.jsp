...
<body>
    ...
    <div>
        ...
        <table id="clTable">
            ...
            <tr>
                <td></td>
                <td><p style="font-size: 7px; float: left;">*얼굴 공개를 원하시지 않을 경우 일반클래스 사진 올려주시면 됩니다.</p></td>
            </tr>
            <tr>
                <td>강사소개</td>
            ...
            <tr>
                ...
                <input type="text" readonly style="width : 400px; float: left; border: transparent; background-color: transparent;">
                </td>
            </tr>
            ...
            <tr>
                ...
                <input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기" class = "classdes"><br>
        ...
        <div class = "btnarea">
        <button type="button" class="btn" id="register">클래스정보 수정하기</button> 
        &nbsp;
