    ...
    <section class="box">
            <div class="cir">
                <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#4B654A" d="M67.3,-21C76.6,6.9,66.4,42.1,42.4,59.8C18.5,77.5,-19.1,77.8,-43.5,60C-67.8,42.3,-79,6.5,-69.5,-21.6C-60.1,-49.6,-30,-69.9,-0.5,-69.7C29,-69.6,57.9,-48.9,67.3,-21Z" transform="translate(100 100)" />
                </svg>
            </div>
            <div class="ad center">
