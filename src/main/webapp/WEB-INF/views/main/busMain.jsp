        ...
        <div class="swiper-slide">
          <div class="card">
            <div class="card__body">
              ...
              <div class="card-tags">
                <a href="#" target="_blank" class="card-tags__item">HOME</a>
                <a href="#" target="_blank" class="card-tags__item">ORDER</a>
                <a href="#" target="_blank" class="card-tags__item">RESERVATION</a>
