			...
			<div class="galleryArea" style="margin: 0%; "> 
				...
				<div class="store" style="top: 5px; left: 35px; " > 
					<div class="container" style="background-color: white;" >
						<div id="bigImages">
                            <img id="big" src="../resources/images/store/텀블러.jpg" style="width: 430px; height:  400px"  >
                         </div> 
                         <div id="smallImages">
                            <img class="small"  src="../resources/images/store/텀블러.jpg">
                            <img class="small"  src="../resources/images/store/텀블러2.jpg">
                            <img class="small"  src="../resources/images/store/텀블러.jpg"> 
                         </div>  
                         <script>
				...
				<div class="rvt"
					...
					<table id="info">
						...
						<td>
						<tr>
							<p class="store_info"   > &nbsp 카테고리: 
							</p>
						</tr>
						<br>
						<tr>
							<p class="store_info"  > &nbsp 원산지:  
							</p>
						</tr>
						<br>
						<tr>
							<p class="store_info"  > &nbsp 가격:  
							</p>
						</tr>
						<br>
						</td>
						<tr>
							<p class="store_info"  > &nbsp 배송비: 
							</p>
						</tr>
                        <br>
                        <tr>
                      ...
                      <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row align-items-center py-md-3">
                                    ...
                                    margin-left: 0px;
                                "><img class="d-block rounded-3" src="../resources/images/store/텀블러.jpg" alt="Image"></div>
                                    <!--설명-->
                                ...
                                <div class="col-lg-5 col-md-6 offset-lg-1"><img class="d-block rounded-3" src="../resources/images/store/텀블러2.jpg" alt="Map"></div>
