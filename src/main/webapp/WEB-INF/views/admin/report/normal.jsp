...
<html>
	<head>
		...
		<link rel="stylesheet" href="${ contextPath }/resources/css/admin/report/normal.css" />
		...
		<div id="whole-container">
			...
			<section id="right-area">
				...
				<div id="contents-container">
					<div id="ad-container">
						<div id="waiting">
							<span class="ad-title">처리 대기</span>
							<zing-grid
								id="waiting-list"
								sort
								pager
					...
					<div id="img-container">
						<div id="img-box">
							...
							<div id="ad-buttons">
								<button class="gray btn-style">해 제</button>
								<button class="red btn-style">제 재</button>
							</div>
						</div>
					</div>
				</div>
